-- Jolt — TEST-MODE commission settlement.
--
-- Until a real payment provider is wired up, the provider clears their whole
-- commission debt from their in-app wallet balance: the owed amount is deducted
-- from wallet_balance, the debt is zeroed, and they're unblocked. Replace this
-- with a real payment flow in production.
...
begin
  ...
  if v_owed > 0 then
    ...
    update provider_wallets
       set wallet_balance = wallet_balance - v_owed,
