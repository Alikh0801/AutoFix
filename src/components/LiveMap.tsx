...
// Leaflet + CARTO's free dark tiles, loaded from CDN inside a WebView — no
// API key, no dev build (react-native-webview ships inside Expo Go, unlike
// react-native-maps / expo-maps which both require one). This is the "free
// tier" live map; swap the tile layer for Google Maps once that migration
// happens.
...
<style>
  html, body, #map { height: 100%; margin: 0; padding: 0; background: #0E1116; }
